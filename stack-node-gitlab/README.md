...
Service catalog with GitLab CI app stack

This stack will:
  * Create a vpc and a bastion instance you might require to deploy other stacks.
  * Create an instance and deploy Nexus Repository in the vpc created using the bastion server.
...
To run this stack, an [S3 bucket](https://docs.aws.amazon.com/quickstarts/latest/s3backup/step-1-create-bucket.html) is required to store Terraform remote states.
